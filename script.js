...
let platformArrY = [flat1Top, flast2Top, flat3Top];
...
const closestPlatformLeft = () => {
	...
	for (let i = 0; i < platformArrX.length; i++) {
		what2.innerHTML = `${platformArrX[i]} ${platformArrX[i + 2]}`;
...
what.innerHTML = ` ${mapXMap} ${nextLeft} 
